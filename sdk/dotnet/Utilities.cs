...
namespace Jschady.Mailslurp
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/jschady/pulumi-mailslurp";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Jschady.Mailslurp.version.txt");
    ...
    internal sealed class MailslurpResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public MailslurpResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
