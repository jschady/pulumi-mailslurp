module github.com/jschady/pulumi-mailslurp/examples/go

go 1.26.0

require (
	github.com/jschady/pulumi-mailslurp/sdk/go/mailslurp v0.0.0
...
replace github.com/jschady/pulumi-mailslurp/sdk/go/mailslurp => ../../sdk/go/mailslurp
